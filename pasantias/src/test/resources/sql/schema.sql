...
-- Estudiante 2
INSERT INTO Estudiante (dni, apellido, nombre, especialidad, nro_legajo, email, tel_celular, id_usuario, activo)
VALUES ('23456789', 'López', 'María', 'Ingeniería Industrial', 'L002', 'maria.lopez@estudiantes.com', '351-9876543', 2, TRUE);
...
('Desarrollador Backend Java', 'Desarrollador Junior', 'Córdoba', 'Híbrida', 50000.0, 2, DATE_SUB(CURRENT_DATE, INTERVAL 30 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 120 DAY), 'PUBLICADA', 'rrhh@biofarmaweb.com.ar', NULL, NULL, NULL, 1),
('Analista de Sistemas', 'Analista Junior', 'Córdoba', 'Presencial', 45000.0, 1, DATE_SUB(CURRENT_DATE, INTERVAL 28 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 90 DAY), 'PUBLICADA', 'seleccion@hospital-italiano.org.ar', NULL, NULL, NULL, 3),
('Desarrollador Frontend React', 'Desarrollador Frontend', 'Córdoba', 'Remoto', 48000.0, 3, DATE_SUB(CURRENT_DATE, INTERVAL 20 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 75 DAY), 'PUBLICADA', 'natalia.barrionuevo@avenga.com', NULL, NULL, NULL, 6),
('Pasante IT', 'Pasante IT', 'Córdoba', 'Híbrida', 725888.0, 3, DATE_SUB(CURRENT_DATE, INTERVAL 10 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 150 DAY), 'PUBLICADA', 'rrhh@claro.com.ar', 'Conocimientos de lenguaje de base de datos Oracle\nConocimientos en metodologías ágiles y DevOps\nConocimientos de Linux\nPoder dar soporte a ejecuciones realizadas por los usuarios que usan las herramientas de IC/DC\nInglés (nivel medio)', 'Simplicidad en tu forma de pensar y hacer\nVocación de servicio', 'OSDE 210', 19),
('Pasante de Garantía', 'Pasante de Garantía', 'Córdoba', 'Presencial', 712656.0, 2, DATE_SUB(CURRENT_DATE, INTERVAL 10 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 150 DAY), 'PUBLICADA', 'rocio.suarez@grupoquijada.com.ar', 'Estudiantes que estén cursando 3ro o 4to año tendrían los conocimientos necesarios para poder desempeñarse en la posición', 'Manejo de Excel (Básico)', 'SWISS MEDICAL SMG 20', 20),
('Pasante en Seguridad y Ambiente', 'Pasante en Seguridad y Ambiente', 'Córdoba', 'Presencial', 473101.0, 1, DATE_SUB(CURRENT_DATE, INTERVAL 10 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 150 DAY), 'PUBLICADA', 'alfonsina.gioino@dayco.com', 'Conocimiento Excel avanzado', NULL, NULL, 21),
('Auxiliar de soporte técnico', 'Auxiliar de soporte técnico', 'Córdoba', 'Presencial', 532411.18, 1, DATE_SUB(CURRENT_DATE, INTERVAL 10 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 150 DAY), 'PUBLICADA', 'azul.merlo@hospitalprivado.com.ar', 'Conocimientos en reparación y armado de computadoras, redes, impresoras, entre otras. Buen manejo de Word y Excel.', NULL, 'Ninguno', 22);
